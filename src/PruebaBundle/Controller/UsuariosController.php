...
class UsuariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $usuarios = $em->getRepository('PruebaBundle:Usuarios')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PruebaBundle\Form\UsuariosType', $usuario);
    ...
    {
        $deleteForm = $this->createDeleteForm($usuario);
        $editForm = $this->createForm('PruebaBundle\Form\UsuariosType', $usuario);
